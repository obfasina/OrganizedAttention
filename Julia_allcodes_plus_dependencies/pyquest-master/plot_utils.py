...
original_rbmap = plt.get_cmap("RdBu_r")

# Access the private data of the colormap
cmap_data_rb = original_rbmap._segmentdata

# Create a new colormap that mimics 'RdBu_r' with modifications
rbmap = matplotlib.colors.LinearSegmentedColormap('RdBu_r_modified', cmap_data_rb)

# Set 'under' and 'over' colors on the new colormap
...
# Create a copy of the 'binary_r' colormap
# Get the original 'binary_r' colormap
original_cmap = plt.get_cmap("binary_r")

# Create a new colormap that mimics 'binary_r' but with modifications
cmap_data = original_cmap._segmentdata  # Access the private data
bwmap = matplotlib.colors.LinearSegmentedColormap('binary_r_modified', cmap_data)
